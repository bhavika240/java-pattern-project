...
class ascii
{
    public static void main(String args[])
    {
        ...
        System.out.print("6. Show String\n");
...
//yha se string wala jodha h pehle name fr number then symbol ok krke dekh lena
    public static void showString(String[][] s, String[][] num, String[][] sym) {
    Scanner input = new Scanner(System.in);
    ...
    for (int i = 0; i < 7; i++) {
        ...
        if (hasSymbol) System.out.println();
    }
}
